                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${widget.activeCoupons.length} ready to use',
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          final coupon = widget.activeCoupons[index];
                          return Column(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (ticket.status != 'closed') ...[
                              TextField(
                                controller: _replyControllerFor(ticket.id),
                                minLines: 1,
                                maxLines: 3,
                              ...
                              Wrap(
                                ...
                                children: [
                                  FilledButton.icon(
                                    onPressed: () async {
                                      final text = _replyControllerFor(
                                        ticket.id,
                                      ).text.trim();
                                      if (text.length < 3) {
                                        return;
                                      }
                                      await widget.onReplySupport(
                                        ticket.id,
                                        text,
                                      );
                                      _replyControllerFor(ticket.id).clear();
                                    },
                                  ...
                                  TextButton(
                                    onPressed: () =>
                                        widget.onCloseSupport(ticket.id),
